...
#####################################
#Local workflow on FLPs for FEE task
#####################################
WF_NAME=its-qcmn-fee-no-ds-entire-local
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/its-qcmn-fee-no-ds-entire.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/its-qcmn-fee-no-ds-entire-{{ it }}'
...
#Remote workflow
#############################
WF_NAME=its-qcmn-epn-calibration-fee-remote
QC_GEN_CONFIG_PATH='json://'`pwd`'/scripts/etc/its-qcmn-epn-calibration-fee.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/its-qc-calibration-fee'
QC_CONFIG_PARAM='qc_config_uri'
